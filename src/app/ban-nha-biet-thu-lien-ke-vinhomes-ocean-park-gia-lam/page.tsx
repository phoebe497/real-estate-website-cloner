...
import listingsData from '@/data/batdongsan.com.vn/villas.json';
          ...
          <div className="re__main-content-layout flex flex-col lg:flex-row gap-6">
            ...
            <div className="re__main-left flex-1">
              <h1 className="text-xl font-bold mb-4 uppercase">
                Bán nhà biệt thự liền kề Vinhomes Ocean Park Gia Lâm
              </h1>
            ...
            <div className="re__main-right hidden lg:block w-[300px]">
              <div className="bg-background border border-border p-4 rounded-lg sticky top-[80px]">
                <h3 className="font-bold mb-3 border-b border-border pb-2">Lọc theo tiểu khu</h3>
                <ul className="space-y-2 text-sm">
                  <li className="text-primary font-medium">Ngọc Trai</li>
                  <li className="hover:text-primary cursor-pointer">Sao Biển</li>
                  <li className="hover:text-primary cursor-pointer">Hải Âu</li>
                  <li className="hover:text-primary cursor-pointer">San Hô</li>
                </ul>
              </div>
            </div>
          </div>
